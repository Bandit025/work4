...
?>
    ...
    <?php require_once 'nav_admin.php';?>
        <div class="container">
            ...
            <h3 class="mt-4">รายการคอร์สทั้งหมด</h3> <a href="insert_couse_form.php" class="btn btn-success">เพิ่มคอร์ส</a>
            <table class="table">
                <thead>
                    <tr>
                ...
                <?php while ($row = mysqli_fetch_assoc($re_stmt)) { ?>
                    <tr>
                        ...
                        <td><a  href="edit_course.php?id_course=<?php echo $row["id_course"] ?>" class="btn btn-warning">แก้ไข</a></td>
                        <td><a href="#" onclick="confirmDelete('<?php echo $row['id_course']; ?>')" class="btn btn-danger">ลบ</a></td>
                    </tr>
